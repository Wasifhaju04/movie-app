...
from . models import Movie, Blog, contact, order
...
def details(req,id):
    ...
    print(params)   
    return render(req,"detail.html",params)
...
def blogView(req):
    return render(req,"blogcreate.html")
...
def blogdetails(req,id):
    ...
    return render(req,"blogdetails.html",params)
...
def bloglist(req):
    ...
    return render(req,"bloglist.html",params)